# Single-stage build on Node 8 (Debian) — the original era of this codebase.
# Avoids the hybrid Node 8 → Node 20 problem; sharp's native binary works
# because the runtime is the same Node version it was compiled for.
FROM node:8
